...
set "QTINSTALL=C:\Qt\5.12.5-maya"
...
REM Step 2: Switch to v5.12.5 tag
echo Step 2: Switch to v5.12.5 tag
cd /d "%QTSRC%"
git checkout v5.12.5
if errorlevel 1 (echo ERROR: failed to checkout v5.12.5 & pause & exit /b 1)
...
REM Step 6: Build (Qt 5 uses nmake)
echo Step 6: Build
nmake
