REM ========================================
REM Build Qt 5.6.1 for Maya 2019
REM ========================================
REM Prerequisites:
REM - Visual Studio 2019 or 2022 (MSVC)s
...
cd "%USERPROFILE%\Desktop\Qt\qt5"s
git checkout v5.6.1
...
:: Advanced
::perl init-repository --module-subset=qtbase,qttools,qt3d,qtactiveqt,qtconnectivity,qtdeclarative,qtenginio,qtlocation,qtmultimedia,qtscript,qtsensors,qtserialbus,qtserialport,qtsvg,qtwebchannel,qtwebengine,qtwebkit,qtwebsockets,qtwebview,qtwinextras,qtxmlpatterns

REM Step 4: Configure Qt 5.6.1 to match Maya's build
call configure.bat -prefix C:\Qt\5.6.1-maya -opensource -confirm-license -release -nomake examples -nomake tests
